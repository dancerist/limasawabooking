...
| `limasawa-admin.php` | WP-admin CMS: Overview dashboard widget (counts + pending-payment/listing queues), one-click **approve-payment → paid + publish + apply tier + set expiry** (`admin_post`), publish-listing, admin columns (tier/payment/host). Cap `edit_others_posts`. Live & verified 2026-06-01. |
